...
namespace ECE141 {
  ...
  enum class Keywords {
    ...
    in_kw, inner_kw, insert_kw, integer_kw, into_kw, join_kw, key_kw, left_kw, limit_kw,
    ...
    values_kw, varchar_kw, version_kw, where_kw, default_kw, createDB_kw, dropDB_kw, useDB_kw, showDB_kw, describeDB_kw, createTB_kw, dropTB_kw, showTB_kw, describeTB_kw, indexes_kw,
  };
