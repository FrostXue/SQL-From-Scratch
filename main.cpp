...
static std::map<int, std::string> theErrorMessages = {
  ...
  {ECE141::seekError,   "Seek Error"},
  {ECE141::illegalIdentifier,   "Illegal Identifier"},
  {ECE141::noDatabaseSpecified,   "No Database Specified"},
  {ECE141::invalidAttribute, "Attribute Invalid"}
};
...
int main(int argc, const char * argv[]) {
  ...
  ECE141::AppCmdProcessor   theProcessor(&theSQLProcessor);  //add your db processor here too!
